...
public class daoBitacora {
    private static final String SQL_SELECT = "SELECT bitid,bitfecha,bitaccion,bitip,usId FROM tbl_bitacora";
//private static final String SQL_SELECT = "SELECT bitid, bitfecha, bitaccion, usId, aplid, bitip, bitnombrepc, calcularDescuento(1000, 10) FROM tbl_bitacora";    
    private static final String SQL_INSERT = "INSERT INTO tbl_bitacora(bitid,bitfecha,bitaccion,bitip,usId) VALUES(?, ?, ?, ?)";
    private static final String SQL_QUERY = "SELECT bitid,bitfecha,bitaccion,bitip,usId FROM tbl_bitacora WHERE bitfecha BETWEEN ? AND ?";
